...
patches=''
export patches
NIX_CFLAGS_COMPILE=' -frandom-seed=xjjag3wjah -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/d9h9bk33hbfj8w0qgi07adqn54vb1kp8-nodejs-20.20.1/include -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/d9h9bk33hbfj8w0qgi07adqn54vb1kp8-nodejs-20.20.1/include'
...
export CC
outputDev='out'
DEVENV_TASK_FILE='/nix/store/yhj9p0ypb3qnbx0b3scrkladcwlyfvfl-tasks.json'
...
prefix='/nix/store/xjjag3wjahkx6v22f7hrc03780yhq2d3-devenv-shell-env'
...
'
export buildPhase
out='/nix/store/xjjag3wjahkx6v22f7hrc03780yhq2d3-devenv-shell-env'
export out
...
export CXX
NIX_NO_SELF_RPATH='1'
NIX_LDFLAGS='-rpath /nix/store/xjjag3wjahkx6v22f7hrc03780yhq2d3-devenv-shell-env/lib  -L/nix/store/fhjcar6z841y22rb5l0sclfxn11gipmb-mariadb-server-11.4.9/lib -L/nix/store/fhjcar6z841y22rb5l0sclfxn11gipmb-mariadb-server-11.4.9/lib'
export NIX_LDFLAGS
DEVENV_TASKS=''
export DEVENV_TASKS
doCheck=''
...
exec /tmp/devenv-env1yzHKc/script 
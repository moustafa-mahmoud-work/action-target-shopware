...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/hlxw2q9qansq7bn52xvlb5badw3z1v8s-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/mr15agc6pg1wlg7i1w4s1p9whx77psj5-devenv-profile" ]
then
  ln -snf /nix/store/mr15agc6pg1wlg7i1w4s1p9whx77psj5-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
export phases
defaultBuildInputs=''
DEVENV_TASK_FILE='/nix/store/7y9l5gc9ww2rnsnkb5jhqy23k7f7rggv-tasks.json'
...
buildInputs=''
export buildInputs
out='/nix/store/375kn85zc4nk9hq846zi099851pn65hz-devenv-shell-env'
export out
...
NM='nm'
export NM
NIX_LDFLAGS='-rpath /nix/store/375kn85zc4nk9hq846zi099851pn65hz-devenv-shell-env/lib  -L/nix/store/fhjcar6z841y22rb5l0sclfxn11gipmb-mariadb-server-11.4.9/lib -L/nix/store/fhjcar6z841y22rb5l0sclfxn11gipmb-mariadb-server-11.4.9/lib'
export NIX_LDFLAGS
LOCK_DSN='flock'
export LOCK_DSN
depsTargetTarget=''
...
APP_ENV='prod'
export APP_ENV
prefix='/nix/store/375kn85zc4nk9hq846zi099851pn65hz-devenv-shell-env'
strictDeps=''
export strictDeps
...
export name
NIX_CFLAGS_COMPILE=' -frandom-seed=375kn85zc4 -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/d9h9bk33hbfj8w0qgi07adqn54vb1kp8-nodejs-20.20.1/include -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/d9h9bk33hbfj8w0qgi07adqn54vb1kp8-nodejs-20.20.1/include'
export NIX_CFLAGS_COMPILE
shell='/nix/store/2hjsch59amjs3nbgh7ahcfzm2bfwl8zi-bash-5.3p9/bin/bash'
export shell
DEVENV_PROFILE='/nix/store/mr15agc6pg1wlg7i1w4s1p9whx77psj5-devenv-profile'
...
exec /tmp/devenv-envgCKzQj/script 
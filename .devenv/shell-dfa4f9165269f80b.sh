...
prefix='/nix/store/myflpwrn7z4s81zcs0a9n5fzmrxljf7b-devenv-shell-env'
...
out='/nix/store/myflpwrn7z4s81zcs0a9n5fzmrxljf7b-devenv-shell-env'
export out
...
LINENO='79'
outputBin='out'
NIX_LDFLAGS='-rpath /nix/store/myflpwrn7z4s81zcs0a9n5fzmrxljf7b-devenv-shell-env/lib  -L/nix/store/fhjcar6z841y22rb5l0sclfxn11gipmb-mariadb-server-11.4.9/lib -L/nix/store/fhjcar6z841y22rb5l0sclfxn11gipmb-mariadb-server-11.4.9/lib'
export NIX_LDFLAGS
OSTYPE='linux-gnu'
...
export DEVENV_ROOT
HOSTTYPE='x86_64'
NIX_CFLAGS_COMPILE=' -frandom-seed=myflpwrn7z -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/d9h9bk33hbfj8w0qgi07adqn54vb1kp8-nodejs-20.20.1/include -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/d9h9bk33hbfj8w0qgi07adqn54vb1kp8-nodejs-20.20.1/include'
...
DEVENV_TASK_FILE='/nix/store/fgmh12dlfmjb6pcjb6lsgv3r7pk5yyp7-tasks.json'
...
exec /tmp/devenv-envDXu23L/script 
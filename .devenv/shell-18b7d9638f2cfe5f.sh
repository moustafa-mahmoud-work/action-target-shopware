...
export HOST_PATH
NIX_CFLAGS_COMPILE=' -frandom-seed=5s6fw2acdz -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/d9h9bk33hbfj8w0qgi07adqn54vb1kp8-nodejs-20.20.1/include -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/d9h9bk33hbfj8w0qgi07adqn54vb1kp8-nodejs-20.20.1/include'
...
prefix='/nix/store/5s6fw2acdz2ra1vlw0r2x9wbs4n67y20-devenv-shell-env'
...
export PKG_CONFIG
NIX_LDFLAGS='-rpath /nix/store/5s6fw2acdz2ra1vlw0r2x9wbs4n67y20-devenv-shell-env/lib  -L/nix/store/fhjcar6z841y22rb5l0sclfxn11gipmb-mariadb-server-11.4.9/lib -L/nix/store/fhjcar6z841y22rb5l0sclfxn11gipmb-mariadb-server-11.4.9/lib'
export NIX_LDFLAGS
depsHostHost=''
export depsHostHost
outputBin='out'
...
XDG_DATA_DIRS='/nix/store/0550j0i8bmzxbcnzrg1g51zigj7y12ih-bash-interactive-5.3p9/share:/nix/store/fhjcar6z841y22rb5l0sclfxn11gipmb-mariadb-server-11.4.9/share:/nix/store/x8iqvc0qfzsnhrmc9bdr3bz620d051ma-php-with-extensions-8.2.30/share:/nix/store/l9kxsspx3lvrj1k6xcpwfsazb019jfcz-composer-2.9.5/share:/nix/store/7vvfrrgbni04wnd1cqz0y4qw8c8hncsv-phpactor-2025.12.21.1/share:/nix/store/8x49w8i0vafv34rlc6h4a0f7z0z2qpb5-git-2.53.0/share:/nix/store/h1f12q18gyrcj5agdk495ksgky6q9bl9-composer-2.9.5/share:/nix/store/d9h9bk33hbfj8w0qgi07adqn54vb1kp8-nodejs-20.20.1/share:/nix/store/1nv3i8mpypy3d516f4pd95m0w72r73jy-pkg-config-wrapper-0.29.2/share:/nix/store/590yx3aynyhs48jyk8ip37fk1mjqfhkb-patchelf-0.15.2/share'
...
export PHPFPMDIR
out='/nix/store/5s6fw2acdz2ra1vlw0r2x9wbs4n67y20-devenv-shell-env'
export out
shellHook='
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/hlxw2q9qansq7bn52xvlb5badw3z1v8s-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/ff5khbiacby1vqmj477acv4z6jmq9msw-devenv-profile" ]
then
  ln -snf /nix/store/ff5khbiacby1vqmj477acv4z6jmq9msw-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mesonFlags=''
export mesonFlags
DEVENV_PROFILE='/nix/store/ff5khbiacby1vqmj477acv4z6jmq9msw-devenv-profile'
...
exec /tmp/devenv-env0QuHen/script 
...
source "/home/linux_user/code/shopware6/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/tmp/devenv-reload-4851.sh" ]; then
        ...
        source "/tmp/devenv-reload-4851.sh"
        rm -f "/tmp/devenv-reload-4851.sh"
